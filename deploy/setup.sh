...
PROJECT_GIT_URL='https://github.com/pyagmyrov/rest.git'

PROJECT_BASE_PATH='/usr/local/apps/rest'
...
cp $PROJECT_BASE_PATH/deploy/supervisor_core.conf /etc/supervisor/conf.d/rest.conf
